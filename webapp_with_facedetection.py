...
# Set page title
st.set_page_config(page_title="Face Detection Web App")
...
def main():
    ...
    # Perform face detection after successful login
    if st.session_state.is_logged_in:
        st.header("Face Detection")
        if not st.session_state.is_camera_running:
            st.write("Click the 'Start' button to begin face detection.")
            if st.button("Start"):
